...
namespace TitaniumAS.Opc.Client.Schedulers;
...
public sealed class StaTaskScheduler : TaskScheduler, IDisposable
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="StaTaskScheduler"/> class with the specified concurrency level.
    /// </summary>
    ...
    /// <summary>
    /// Queues a <see cref="Task"/> to be executed by this scheduler.
    /// </summary>
    ...
    /// <summary>
    /// Determines whether a <see cref="Task"/> may be inlined.
    /// </summary>
    /// <param name="task">The task to be executed.</param>
